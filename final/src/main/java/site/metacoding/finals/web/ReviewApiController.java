...
import site.metacoding.finals.service.ImageFileService;
...
public class ReviewApiController {
    ...
    public ResponseEntity<?> saveReview(@RequestPart("file") List<MultipartFile> file,
        ...
        imageFileService.storeFile(file);
        return new ResponseEntity<>(new ResponseDto<>(HttpStatus.CREATED, "리뷰 저장", null), HttpStatus.CREATED);
    }
}
