...
insert into shop(set_reservation_date, category, address, closetime, image, information, opentime, per_hour, per_price, phone_number, shop_name, user_id, created_at)
values (20221130, '한식', '가게주소', '22', '이미지1', '소개', '10', '1', '10000', '01011113333', '가게', 2, now());
